...
class RIOTest(multinetwork_base.MultiNetworkBaseTest):
  ...
  def setUp(self):
    ...
    if multinetwork_base.HAVE_ACCEPT_PIO_PFLAG:
      self.SetAcceptPioPflag(0)
  ...
  def SetAcceptPioPflag(self, val):
    self.SetSysctl(
        "/proc/sys/net/ipv6/conf/%s/accept_pio_pflag" % self.IFACE, val)
  ...
  @unittest.skipUnless(multinetwork_base.HAVE_ACCEPT_PIO_PFLAG,
                       "needs support for accept_pio_pflag")
  def testPioPflag(self):
    self.SetAcceptPioPflag(1);
