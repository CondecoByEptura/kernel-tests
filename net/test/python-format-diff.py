#!/usr/bin/env python
#
#===- python-format-diff.py - YAPF Diff Reformatter ----*- python -*--===#
#
#===------------------------------------------------------------------------===#

r"""
YAPF Diff Reformatter
============================
...
Example usage for git/svn users:
  ...
  git diff -U0 --no-color HEAD^ | python-format-diff.py -p1 -i
  svn diff --diff-cmd=diff -x-U0 | python-format-diff.py -i
