...
TCP_REPAIR = 19  # SOL_TCP level option
TCP_REPAIR_OFF =0  # an argument to TCP_REPAIR
TCP_REPAIR_ON = 1  # an argument to TCP_REPAIR

TCP_REPAIR_QUEUE = 20  # SOL_TCP level option
TCP_NO_QUEUE = 0  # an argument to TCP_REPAIR_QUEUE
TCP_RECV_QUEUE = 1  # an argument to TCP_REPAIR_QUEUE
TCP_SEND_QUEUE = 2  # an argument to TCP_REPAIR_QUEUE

TCP_QUEUE_SEQ = 21 # SOL_TCP level option
...
class TcpRepairTest(multinetwork_base.MultiNetworkBaseTest):
  ...
  def PollWhenShutdownTest(self, version):
    ...
    self.assertThreadsStopped(multiThreads, "poll fail in SHUT_RD")
    sock.close()
    ...
    self.assertThreadsStopped(multiThreads, "poll fail in SHUT_WR")
    sock.close()
    ...
    self.assertThreadsStopped(multiThreads, "poll fail in SHUT_RDWR")
    sock.close()
  ...
  def PollWhenReceiveFinTest(self, version):
    ...
    self.assertThreadsStopped(multiThreads, "poll fail in FIN")
    sock.close()
