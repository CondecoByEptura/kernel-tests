...
class Xfrm(netlink.NetlinkSocket):
  ...
  def CreateTunnel(self,
    ...
    Args:
      ...
      match_method: One of MATCH_METHOD_[MARK | ALL | IFID]. Defaults to
        MATCH_METHOD_ALL. Setting this determines how the SAs and policies are
        matched.
    """
