...
<<<<<<< TARGET BRANCH (0f7c16 [automerger skipped] Merge "Use blocking sockets with timeou)
...
>>>>>>> SOURCE BRANCH (122de3 Merge branch 'android11-dev' into 'android11-tests-dev')
  || exitcode=$?
