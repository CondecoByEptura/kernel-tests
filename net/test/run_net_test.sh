...
OPTIONS="$OPTIONS XFRM_USER CRYPTO_CBC CRYPTO_CTR CRYPTO_HMAC CRYPTO_AES"
OPTIONS="$OPTIONS CRYPTO_SHA1 CRYPTO_SHA256 CRYPTO_SHA12 CRYPTO_USER"
OPTIONS="$OPTIONS INET_AH INET_ESP INET_XFRM_MODE_TRANSPORT INET_XFRM_MODE_TUNNEL"
OPTIONS="$OPTIONS INET6_AH INET6_ESP INET6_XFRM_MODE_TRANSPORT INET6_XFRM_MODE_TUNNEL"
OPTIONS="$OPTIONS CRYPTO_SHA256 CRYPTO_SHA512 CRYPTO_AES_X86_64 CRYPTO_ECHAINIV"
