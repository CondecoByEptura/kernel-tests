...
class Ping6Test(multinetwork_base.MultiNetworkBaseTest):
  ...
  def setUpClass(cls):
    ...
    cls.loglevel = cls._GetConsoleLogLevel()
    cls._SetConsoleLogLevel(6)
    cls.reply_threads = {}
    for netid in cls.NETIDS:
  ...
  def tearDownClass(cls):
    ...
    loglevel = cls._SetConsoleLogLevel(cls.loglevel)
