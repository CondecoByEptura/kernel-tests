...
module_dir=/root/lib/modules/`uname -r`/kernel
/tmp/insmod ${module_dir}/drivers/virtio/virtio_pci_modern_dev.ko
/tmp/insmod ${module_dir}/drivers/virtio/virtio_pci.ko
/tmp/insmod ${module_dir}/drivers/block/virtio_blk.ko

# Give the crng init a boost, but if this module is missing, don't fail
/tmp/insmod ${module_dir}/drivers/char/hw_random/virtio-rng.ko || true
