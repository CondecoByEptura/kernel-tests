...
# Remove the initramfs related packages, as the initrd is transformed
# for GKI anyway and it does not make sense to regenerate it from the
# Debian rootfs
dpkg -P initramfs-tools initramfs-tools-core klibc-utils kmod
