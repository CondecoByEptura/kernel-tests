...
_ALGO_AUTH_NULL = (xfrm.XfrmAlgoAuth(
                   ("digest_null", 0, 0, net_test.LINUX_ANY_VERSION)), "")
_ALGO_HMAC_SHA1 = (xfrm.XfrmAlgoAuth(
                   (xfrm.XFRM_AALG_HMAC_SHA1, 128, 96, net_test.LINUX_ANY_VERSION)),
                   _AUTHENTICATION_KEY_128)

_ALGO_CRYPT_NULL = (xfrm.XfrmAlgo(
                    ("ecb(cipher_null)", 0, net_test.LINUX_ANY_VERSION)), "")
_ALGO_CBC_AES_256 = (xfrm.XfrmAlgo(
                     (xfrm.XFRM_EALG_CBC_AES, 256, net_test.LINUX_ANY_VERSION)),
                     _ENCRYPTION_KEY_256)
