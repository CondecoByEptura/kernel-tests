...
class XfrmBaseTest(multinetwork_base.MultiNetworkBaseTest):
  ...
  def _ExpectEspPacketOn(self, netid, spi, seq, length, src_addr, dst_addr):
    ...
    Args:
      ...
      length: length of the packet's payload or zero to skip this check
      src_addr: source address of the packet or zero to skip this check
      dst_addr: destination address of the packet or zero to skip this check
    """
