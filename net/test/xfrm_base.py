...
def CreateEspPolicyAndTemplate(family, direction, spi, reqid, selector, tun_addrs):
  ...
  Args:
    ...
    selector: A selector, e.g., as returned by EmptySelector or SrcDstSelector.
