...
class XfrmFunctionalTest(xfrm_base.XfrmLazyTest):
  ...
  def testAddSa(self):
    ...
    try:
      ...
      self.xfrm.DeleteSaInfo(TEST_ADDR1, TEST_SPI, IPPROTO_ESP, None)
  ...
  def testUdpEncapRekey(self):
    ...
    # Delete old SAs
    self.xfrm.DeleteSaInfo(remoteaddr, start_spi, IPPROTO_ESP, None)
    self.xfrm.DeleteSaInfo(myaddr, start_spi, IPPROTO_ESP, None)
