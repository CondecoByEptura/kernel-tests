...
class XfrmTest(xfrm_base.XfrmBaseTest):
  ...
  def testAddSa(self):
    self.xfrm.AddMinimalSaInfo("::", TEST_ADDR1, htonl(TEST_SPI), IPPROTO_ESP,
                               ...
                               XfrmTest._ALGO_HMAC_SHA1, XfrmTest._AUTHENTICATION_KEY_128,
                               None, None, None)
    expected = (
        ...
        "\tenc cbc(aes) 0x%s\n"
        "\tsel src ::/0 dst ::/0 \n" % (
            XfrmTest._AUTHENTICATION_KEY_128.encode("hex"),
  ...
  def testFlush(self):
    ...
    self.xfrm.AddMinimalSaInfo("::", "2000::", htonl(TEST_SPI),
                               ...
                               XfrmTest._ALGO_CBC_AES_256,
                               XfrmTest._ENCRYPTION_KEY_256,
                               XfrmTest._ALGO_HMAC_SHA1,
                               XfrmTest._AUTHENTICATION_KEY_128,
                               None, None, None)
