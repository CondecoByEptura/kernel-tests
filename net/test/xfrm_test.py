...
CRYPT_ALGOS = [
    xfrm.XfrmAlgo((XFRM_EALG_CBC_AES, 128)),
    xfrm.XfrmAlgo((XFRM_EALG_CBC_AES, 192)),
    xfrm.XfrmAlgo((XFRM_EALG_CBC_AES, 256)),
]
...
AUTH_ALGOS = [
    ...
    # hash size.
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_MD5, 128, 96)),
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_SHA1, 160, 96)),
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_SHA256, 256, 128)),
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_SHA384, 384, 192)),
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_SHA512, 512, 256)),
    # Test larger truncation lengths for good measure.
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_MD5, 128, 128)),
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_SHA1, 160, 160)),
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_SHA256, 256, 256)),
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_SHA384, 384, 384)),
    xfrm.XfrmAlgoAuth((XFRM_AALG_HMAC_SHA512, 512, 512)),
]
