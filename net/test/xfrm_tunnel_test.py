...
class XfrmTunnelBase(xfrm_base.XfrmBaseTest):
  ...
  def _CheckTunnelInput(self, tunnel, inner_version, local_inner, remote_inner,
    ...
    input_pkt = _GetNullAuthCryptTunnelModePkt(
        ...
        local_inner, tunnel.local, local_port, tunnel.in_spi, seq_num)
  ...
  def _TestTunnel(self, inner_version, outer_version, func, use_null_crypt):
    ...
    try:
      ...
      next_seq_num = func(tunnel, inner_version, local_inner, remote_inner, 1)
      next_seq_num = func(tunnel, inner_version, local_inner, remote_inner,
                          next_seq_num)
    finally:
      if use_null_crypt:
        tunnel.TeardownXfrm()
