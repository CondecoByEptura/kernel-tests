...
class XfrmTunnelTest(xfrm_base.XfrmBaseTest):
  def _GetAddresses(self, inner_version, outer_version):
    ...
    return u_netid, netid, local_inner, remote_inner, local_outer, remote_outer

  def ParamTestTunnelOutput(self, inner_version, outer_version):
    underlying_netid, netid, local_inner, remote_inner, local_outer, \
        remote_outer = self._GetAddresses(inner_version, outer_version)
