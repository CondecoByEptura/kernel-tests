...
class XfrmAlgorithmTest(xfrm_base.XfrmBaseTest):
  ...
  def ParamTestSocketPolicySimple(self, params):
    ...
    ekey_left = os.urandom(params["crypt"].key_len / 8) if params["crypt"] else None
    akey_left = os.urandom(params["auth"].key_len / 8) if params["auth"] else None
    aeadkey_left = os.urandom(params["aead"].key_len / 8) if params["aead"] else None
    ekey_right = os.urandom(params["crypt"].key_len / 8) if params["crypt"] else None
    akey_right = os.urandom(params["auth"].key_len / 8) if params["auth"] else None
    aeadkey_right = os.urandom(params["aead"].key_len / 8) if params["aead"] else None
