...
class TunTwister(object):
  ...
  TunTwister is a context manager that will read packets from a tun/tap file
  descriptor, swap the source and dest of the ethernet and IP headers, and write
  them back. Setting up routing such that packets will be routed to the tun/tap
  interface is beyond the scope of this class.
