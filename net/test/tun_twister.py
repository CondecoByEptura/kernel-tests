...
class TunTwister(object):
  ...
  def __init__(self, fd=None, validator=None):
    ...
    The validator is a function taking one argument. It is called with a scapy
    object representing the current packet. The validator function is called
    for each packet *before* twisting.
