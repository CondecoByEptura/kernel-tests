...
def main():
  ...
  if not CheckYapf():
    logging.error('yapf not installed. Try running\n\tsudo pip install yapf')
    exit(1)
  ...
  files = subprocess.check_output(
      full_git_command.split(), stderr=subprocess.DEVNULL).decode('utf-8')
  ...
  diff_output = subprocess.check_output(
      yapf_command, stdout=subprocess.PIPE,
